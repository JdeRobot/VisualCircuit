...
angular.module('icestudio')
  .controller('MenuCtrl', function ($rootScope,
    ...
    function exportFromCompiler() 
    {

      if (project.path === '') {
       alertify.error(gettextCatalog.getString('Save Project First!'), 30); 
      }
	else
	{
...
*/
    ...
    $scope.about = function () {
      var content = [
        '<div class="row">',
        '  <div class="col-sm-4">',
        '   <img src="resources/images/jderobot-logo.png">',
        '  </div>',
        '  <div class="col-sm-7" style="margin-left: 30px;">',
        '    <h4>VisualCircuit</h4>',
        '    <p><i>Visual editor for programming robotic applications</i></p>',
        ...
        '<li><strong>Muhammad Taha Suhail</strong>, creator&nbsp;&nbsp;&nbsp;',
        '<a class="action-open-url-external-browser" href="https://github.com/AbsorbedInThought"><img class="credits-rss-icon" src="resources/images/icon-github.svg"></a>&nbsp;&nbsp;',
        '<a class="action-open-url-external-browser" href="https://twitter.com/Muhamma17873411"><img class="credits-rss-icon" src="resources/images/icon-twitter.svg"></a>',
        '</li>',
        '           <li><strong>JoseMaria Canas</strong>, concepts and development&nbsp;&nbsp;&nbsp;',
        '<a class="action-open-url-external-browser" href="https://github.com/jmplaza"><img class="credits-rss-icon" src="resources/images/icon-github.svg"></a>&nbsp;&nbsp;',
        '<a class="action-open-url-external-browser" href="https://twitter.com/CanasPlaz"><img class="credits-rss-icon" src="resources/images/icon-twitter.svg"></a>',
        '</li>',
        '</ul><br/>',
        ...
        '    <p style="margin-top:30px;text-align:right;"><span class="copyleft">&copy;</span> <a class="action-open-url-external-browser" href="http://jderobot.github.io">JdeRobot</a> 2019-2020</p>',
        '  </div>',
        '</div>'
      ].join('\n');
