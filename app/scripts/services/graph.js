...
angular.module('visualcircuit')
    .service('graph', function ($rootScope, joint, blocks, profile, utils, common,
        gettextCatalog, nodeDebounce, window) {
        // Variables
        var z = {
            index: 100
        };
        ...
        this.createPaper = function (element) {
            ...
            paper = new joint.dia.Paper({
                ...
                validateConnection: function (cellViewS, magnetS, cellViewT, magnetT, end, linkView) {
                    ...
                    lsize = lsize || 1;
                    if (tsize !== lsize) {
                        warning(gettextCatalog.getString('Invalid connection: {{a}} → {{b}}', {
                            a: lsize,
                            b: tsize
                        }));
                        return false;
        ...
        this.createBlock = function (block) {
            blocks.newBlock(block, function (cell) {
