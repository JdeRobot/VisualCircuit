...
angular.module('visualcircuit')
    .service('common', function (nodePath,
        ...
        this.BLOCKS_DIR = nodePath.join('resources', 'blocks');
        ...
        // Default image for blocks.
        this.DEFAULT_BLOCK_IMG = '';
        // Default clock speed of blocks (miliseconds).
        this.DEFAULT_BLOCK_CLOCK = 500;
