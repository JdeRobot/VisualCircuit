...
/*jshint evil:true */
'use strict';
var VzPlugManager = function () {

    this.pluginDir = false;
    this.pluginUri = false;
    this.plugins = {};

    this.ebus = new VzEventBus();
    this.tpl = new VzTemplateSystem();
    this.parametric = new VzParametricHelper();
    this.toload = 0;
    this.onload = false;

    this.version = function () {

        console.log('VisualCircuit Plugin Manager v0.1');
