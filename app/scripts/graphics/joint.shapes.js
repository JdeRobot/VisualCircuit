...
joint.shapes.ice.CodeView = joint.shapes.ice.ModelView.extend({
    ...
    initialize: function () {
        ...
        var image = 'data:image/svg+xml,' + this.model.get('image');
        /*
        */
        this.$box = $(joint.util.template(
            '\
      <div class="code-block" id="' + blockLabel + '">\
        <div class="image-wrapper"> <img class="block-image" src="' + image + '" /> </div> \
            ...
            ' + editorLabel + '.session.setMode("ace/mode/python");\
      ...
      '
        ...
        this.$image = this.$box.find('.image-wrapper');
